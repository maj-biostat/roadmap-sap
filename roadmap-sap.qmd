...
Pairwise comparisons between all patients are used to compute the as
...
and confidence intervals can be computed via a bootstrap procedure or other methods.
