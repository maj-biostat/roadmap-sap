...
for(i in 1:length(l)){
  ...
  d_1_dec_b <- d_1_dec[!(sim %in% d_1_dec_a$sim), .SD[1], keyby = .(sim)][
    , .(sim, ia, decision = "-")
  ]
  ...
  d_2_dec_b <- d_2_dec[!(sim %in% d_2_dec_a$sim), .SD[1], keyby = .(sim)][
    , .(sim, ia, decision = "-")
  ]
  ...
  # indeterminate trials
  d_3_dec_b <- d_3_dec[!(sim %in% d_3_dec_a$sim), .SD[1], keyby = .(sim)][
    , .(sim, ia, decision = "-")
  ]
  ...
  # indeterminate trials
  d_4_dec_b <- d_4_dec[!(sim %in% d_4_dec_a$sim), .SD[1], keyby = .(sim)][
    , .(sim, ia, decision = "-")
  ]
