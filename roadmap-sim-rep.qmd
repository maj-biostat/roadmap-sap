...
Decision procedures, including thresholds and decision probabilities, follow those that are documented in the current SAP.
At each interim, we assess the posterior and if a decision threshold is met, we make claims as directed by the results.
